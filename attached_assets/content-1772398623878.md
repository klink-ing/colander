...
| Role | Attribute             | Element  | Usage                                                                                                                                                                                        |
| ---- | --------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|      | `aria-label="String"` | `button` | - The initial value of accessible name is "Choose Date".<br>- When users select a date, the accessible name is changed to "Change Date, DATE_STRING" where DATE_STRING is the selected date. |
