    ...
    <Dialog.Root open={open} onOpenChange={setOpen}>
      <Dialog.Portal>
        ...
        <Dialog.Popup
          ...
          className="w-72 fixed inset-y-0 left-0 z-60 -translate-x-full overflow-y-auto bg-background p-6 shadow-xl transition-transform duration-200 ease-out data-ending-style:-translate-x-full data-ending-style:duration-150 data-ending-style:ease-in data-open:translate-x-0"
        >
          {children}
        </Dialog.Popup>
      </Dialog.Portal>
