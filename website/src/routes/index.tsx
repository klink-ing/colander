  ...
  return (
    <main className="page-wrap px-4 pt-14 pb-8">
      <section className="relative flex flex-col items-center text-center">
        <h1 className={cn("mb-10 pt-8 pb-4 type-display-300 text-foreground text-trim-cap")}>
        ...
        <p className="mb-8 max-w-[60ch] pt-6 type-body-300-semi text-balance text-muted-foreground">
          Accessible, customizable calendar components for React. Built on Base UI and the Temporal
          API.
        </p>
      ...
      <section className="bp-6:grid-cols-2 bp-10:grid-cols-5 mt-8 grid gap-4">
        {[
          ...
          <Card key={title} render={<article />} style={{ animationDelay: `${index * 90 + 80}ms` }}>
