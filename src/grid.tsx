 ...
 */
export const Grid = forwardRef<HTMLTableElement, GridProps>(
...
const MonthGrid = forwardRef<HTMLTableElement, GridProps>(
...
const WeeksViewGrid = forwardRef<HTMLTableElement, GridProps>(
  function WeeksViewGrid(props, ref) {
    const {
      render,
      mode: _mode,
      orientation,
...
export const GridBody = forwardRef<HTMLTableSectionElement, GridBodyProps>(
...
const MonthGridBody = forwardRef<HTMLTableSectionElement, GridBodyProps>(
  function MonthGridBody(props, ref) {
