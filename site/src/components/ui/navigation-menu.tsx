...
function NavigationMenuIndicator({
  ...
  return (
    <NavigationMenuPrimitive.Icon
      ...
      {...props}
    >
      <div className="relative top-[60%] h-2 w-2 rotate-45 squircle-tl-sm bg-border shadow-md" />
    </NavigationMenuPrimitive.Icon>
  );
}
